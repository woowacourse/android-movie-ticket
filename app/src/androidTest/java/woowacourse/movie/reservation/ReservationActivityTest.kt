...
class ReservationActivityTest {
    ...
    fun 선택_완료_버튼을_누르면_예매_확인_다이얼로그에_타이틀이_표시된다() {
        ...
        // when: 선택 완료 버튼을 누르면
        Espresso
            .onView(ViewMatchers.withId(R.id.btn_reservation_select_complete))
            .perform(ViewActions.click())

        // then: 예매 확인 다이얼로그에 타이틀이 표시된다
        Espresso
            .onView(ViewMatchers.withText("예매 확인"))
    ...
    fun 선택_완료_버튼을_누르면_예매_확인_다이얼로그에_메시지가_표시된다() {
        ...
        Espresso
            .onView(ViewMatchers.withText("정말 예매하시겠습니까?"))
            .check(ViewAssertions.matches(ViewMatchers.isDisplayed()))
    }
    ...
    fun 선택_완료_버튼을_누르면_예매_확인_다이얼로그에_취소_버튼이_표시된다() {
        ...
        Espresso
            .onView(ViewMatchers.withText("취소"))
            .check(ViewAssertions.matches(ViewMatchers.isDisplayed()))
    }
    ...
    fun 선택_완료_버튼을_누르면_예매_확인_다이얼로그에_예매완료_버튼이_표시된다() {
        ...
        Espresso
            .onView(ViewMatchers.withText("예매 완료"))
            .check(ViewAssertions.matches(ViewMatchers.isDisplayed()))
    }
