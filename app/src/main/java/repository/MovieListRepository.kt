...
object MovieListRepository {
    private val MOVIE_SAMPLE =
        MovieModel(
            ...
            poster = R.drawable.list_poster_sorcerers_stone,
        )

    private val MOVIE_LIST_SAMPLE = (0..10000).flatMap {
        listOf(
            ItemViewType.Movie(
                movie = MOVIE_SAMPLE.copy(title = "해리 포터와 마법사의 돌 ${it}_1"),
    ...
    val movieList = MOVIE_LIST_SAMPLE.toMutableList()
}
