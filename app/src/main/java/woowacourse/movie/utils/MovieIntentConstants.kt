...
object MovieIntentConstants {
    ...
    const val EXTRA_MOVIE_RESERVATION_DATE_POSITION = "movieReservationDatePosition"
    const val EXTRA_MOVIE_RESERVATION_TIME_POSITION = "movieReservationTimePosition"
