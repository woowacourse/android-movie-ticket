...
fun List<MovieContent>.toUiModelList(context: Context): List<MovieListUiModel> {
    return map { it.toUiModel(context) }
}

private fun MovieContent.toUiModel(context: Context): MovieListUiModel {
