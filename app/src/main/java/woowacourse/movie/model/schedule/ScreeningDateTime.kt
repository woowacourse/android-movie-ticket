...
data class ScreeningDateTime(
    ...
    private fun lowerBound() = LocalDateTime.of(dateTime.toLocalDate(), LocalTime.of(9, 0))

    private fun upperBound() = LocalDateTime.of(dateTime.toLocalDate().plusDays(1), LocalTime.of(0, 0))
