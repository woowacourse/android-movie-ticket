...
class MovieScheduleGeneratorTest {
    ...
    fun `날짜의_평일_주말_여부에_따라_리턴되는_시작시간이_달라진다`() {
        assertThat(MovieScheduleGenerator.generateScreeningTimesFor("2024.4.20")[0]).isEqualTo("09:00")
        assertThat(MovieScheduleGenerator.generateScreeningTimesFor("2024.4.22")[0]).isEqualTo("10:00")
    }
}
