...
val movieId = 0L
val screeningDateTime = LocalDateTime.of(2024, 4, 20, 9, 0)
val selectedSeats = SelectedSeats(ReservationCount(3))

val ticket = Ticket(0L, movieId, screeningDateTime, selectedSeats)
